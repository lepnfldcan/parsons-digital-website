...
const pricingCards = [
  {
    ...
    features: [
      '5 custom-designed pages — built from scratch',
      'Looks sharp on every phone, tablet, and laptop',
      'Contact form that lands in your inbox — no spam',
      'Set up to be found on Google from day one',
      '2 revision rounds',
    ] as const,
  ...
  },
  {
    ...
    features: [
      ...
      'Premium mobile experience with motion design',
      'Built to actually rank in local search — not just exist',
      'Visitor analytics + lead tracking, set up properly',
      'Loads in under 2 seconds, guaranteed · 3 revision rounds',
    ] as const,
  ...
  },
  {
    ...
    features: [
      ...
      'Custom motion design throughout the site',
      'Expanded structure — bio, booking, resources, blog',
      'Eligible for Google’s featured answer results',
      'ADA accessible · 30 days post-launch support',
    ] as const,
