...
const pricingCards = [
  {
    ...
    features: [
      ...
      'Contact form that reaches your inbox — spam-filtered, reliable',
      'Set up to be found on Google from day one',
      '2 revision rounds · 2-week turnaround',
    ] as const,
  ...
  },
  {
    ...
    features: [
      ...
      'Motion design that makes your brand feel polished and modern',
      'Built to rank in local search — not just exist, but compete',
      'Visitor analytics + lead tracking, configured properly · 3 revision rounds',
    ] as const,
  ...
  },
  {
    ...
    features: [
      ...
      'Expanded site structure — bio, booking, resources, blog',
      'ADA accessible — WCAG 2.1 AA compliant',
