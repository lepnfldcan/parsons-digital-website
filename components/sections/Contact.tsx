    ...
    <section id="contact" className="max-w-[1200px] mx-auto">
      ...
      <div className="md:hidden py-[80px] px-6 text-center relative overflow-hidden">
        ...
        <div className="relative z-10">
          {/* Section label — Fix 4: single line, no rule */}
          <span style={{
            fontSize: '9px',
            fontWeight: 800,
          ...
          <RevealWrapper delay={100}>
            {/* Fix 3: shortened copy, centered, max-width contained */}
            <p style={{
              fontSize: '15px',
              fontWeight: 300,
          ...
          <RevealWrapper delay={200}>
            {/* Fix 1+2: centered column, natural width — no full-width stretching */}
            <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '12px' }}>

              {/* Email — ghost/glow, matches hero primary button */}
              <a
